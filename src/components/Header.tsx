      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            {/* User */}
            <button className="flex items-center gap-2 px-4 py-2 bg-pink-400 text-white rounded-lg hover:bg-pink-500">
        ...
        {/* Mobile Menu (static visible version) */}
        <div className="md:hidden py-4 border-t">
          <nav className="flex flex-col gap-4">
            <span className="text-left px-4 py-2 text-pink-400 bg-pink-50">
              Home
            </span>
            <span className="text-left px-4 py-2 text-gray-600">
              Products
            </span>
            <span className="text-left px-4 py-2 text-gray-600">
              Contact
            ...
            <div className="px-4 py-2 border-t">
              <button className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-pink-400 text-white rounded-lg">
                <User className="w-4 h-4" />
                Login
              </button>
            </div>
